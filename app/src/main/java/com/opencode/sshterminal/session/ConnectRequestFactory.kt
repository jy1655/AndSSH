...
internal fun ConnectionProfile.toConnectRequest(
    ...
    ConnectRequest(
        ...
        securityKeyApplication = securityKeyApplication,
        securityKeyHandleBase64 = securityKeyHandleBase64,
        securityKeyPublicKeyBase64 = securityKeyPublicKeyBase64,
        securityKeyFlags = securityKeyFlags,
